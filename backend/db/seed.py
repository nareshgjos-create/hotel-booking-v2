    ...
    try:
        ...
        sample_bookings = [
            Booking(
                ...
                room_type_id=room_types[0].id,  # Grand Palace Standard
            ...
            Booking(
                ...
                room_type_id=room_types[6].id,  # Sunset Resort Deluxe
            ...
            Booking(
                ...
                room_type_id=room_types[15].id,  # Mountain Retreat Deluxe
